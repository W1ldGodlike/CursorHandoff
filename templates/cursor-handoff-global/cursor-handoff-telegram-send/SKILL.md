...
Short **meaningful** names, Latin:

- ✅ `settings-panel.png`, `plugins-current.png`, `plugins-reference.png`, `combined-side-by-side.png`
- ❌ `out1.png`, meaningless `screenshot.png`, Cyrillic, spaces

Rules: `[a-z0-9-_.]`, ~40 chars max, unique names per task.
