...
/** Matches dom-extractor: header shows completed time (for 2s or trailing 9s). */
...
/**
 * Derives header activity from recorded raw signals and parsed messages (replay / tests).
 * Aligned with dom-extractor post-processing when full DOM is unavailable.
 */
