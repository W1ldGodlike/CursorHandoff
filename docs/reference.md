...
Lookup for CursorHandoff **1.4.0**: extension commands, settings, security defaults, runtime files, and the health API.
...
**Installed VSIX (Windows, Cursor):** `%USERPROFILE%\.cursor\extensions\cursor-handoff.cursor-handoff-1.4.0\data\`
